...
public class BCBSQLiteHelper extends SQLiteOpenHelper {
	...
	public static final String TABLE_MESSAGES = "messages2";
	public static final String TABLE_MESSAGES_OLD = "messages";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		if (oldVersion == 1) {
			db.execSQL("DROP TABLE IF EXISTS " + TABLE_MESSAGES_OLD);
